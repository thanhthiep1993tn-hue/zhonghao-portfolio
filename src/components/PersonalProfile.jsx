...
function PersonalProfile() {
  return (
    <section className="section section-anchor profile-section" id="profile">
      <div className="shell">
        <div className="section-number">05 / 关于我</div>
        ...
        <div className="profile-story">
          ...
          <Reveal className="profile-portrait-card" delay={0.1}>
            <img src="/assets/life/football-portrait.jpg" alt="钟皓在足球场上" />
        ...
        <div className="interest-grid">
          {interests.map((interest, index) => (
            <Reveal as="article" className={`interest-card ${interest.color}`} delay={(index % 3) * 0.05} key={interest.id}>
              {interest.image ? <img src={interest.image} alt="" /> : <div className="ai-interest-visual"><span>AI</span><i>idea</i><b>→</b><strong>prototype</strong></div>}
